        ...
        <div class="col-lg-3 col-md-6">
          <div class="card mb-5">
            <div class="card-body">
              ...
              <h5>Hsu Abow</h5>
              <p class="ellipsis">需要來大大分享一下清清小森-職人洗塵Dyson清潔有多優秀！家裡有2隻多年前（至少十年了）去日本還有美國帶回Dyson DC34 & V6</p>

            </div>

            <div class="d-flex justify-content-center">
                <div class="pb-4">
                  <a href="https://www.facebook.com/story.php?story_fbid=10160913272548070&id=654283069&mibextid=WaXdOe&rdid=haMl1165aHX4Ze61" target="_blank">
      ...
      <div class="col-lg-3 col-md-6">
          <div class="card mb-5">
            <div class="card-body">
              ...
              <h5>Irenebaby</h5>
              <p class="ellipsis">［ 我們的Dyson無線手持系列吸塵器清潔交給 清清小森-職人洗塵 來守護 ］，雖然本人最近狂熱用Bissell五合一無線吸塵洗地機清潔</p>

            </div>

            <div class="d-flex justify-content-center">
                <div class="pb-4">
                  <a href="https://www.facebook.com/100044432769624/posts/826498022174616/?mibextid=WaXdOe&rdid=fo4ouEN0PntSj7G3" target="_blank">
                    <i class="fab fa-facebook"></i> 貼文連結
                  </a>
                </div>
              </div>
          ...
          <div class="card mb-5">
            <div class="card-body">
              ...
              <h5>即將起飛</h5>
              <p class="ellipsis">好友推薦的這個清理達人真的太優秀這個清理達人「清清小森」，是專門清理Dyson的吸塵器，Dyson一台都不便宜，超怕送修以後被用壞</p>

            </div>

            <div class="d-flex justify-content-center">
                <div class="pb-4">
                  <a href="https://www.facebook.com/100064405401276/posts/818226627000843/?mibextid=WaXdOe&rdid=XpeE6dLN6i1JBeDt" target="_blank">
                    <i class="fab fa-facebook"></i> 貼文連結
                  </a>
                </div>
              </div>
          ...
          <div class="card mb-5">
            <div class="card-body">
              ...
              <h5>Wisely的拍拍照寫寫字</h5>
              <p class="ellipsis">#清清小森 處理的流程完全流程化，會應對不同的型號做拆卸處理，然後再細心地將每個零組件做好清理，並且還會做一番基礎的檢測保養。</p>
            </div>

            <div class="d-flex justify-content-center">
                <div class="pb-4">
                  <a href="https://www.facebook.com/100044379791204/posts/997695685053082/?mibextid=WaXdOe&rdid=1pLXgmgcDG3dQOMm" target="_blank">
                    <i class="fab fa-facebook"></i> 貼文連結
                  </a>
                </div>
              </div>
